...
function UserCard({ user, onConnect, onIgnore, isLoading }: UserCardProps) {
  const defaultProfilePic = "/placeholder.svg?height=300&width=300";
  const defaultCoverPic = "/placeholder.svg?height=400&width=600";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url(${user?.coverPic || defaultCoverPic})`,
        }}
      >
