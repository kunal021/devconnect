        ...
        {posts.map((post, index) => (
          ...
          >
            <motion.article
              ...
              transition={{ duration: 0.5 }}
              className={`${
                id ? "flex items-center justify-between" : ""
              } max-w-3xl mx-auto my-3 px-3 md:px-6 py-3 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-lg`}
            >
              {!id && (
                <motion.div
                  initial={{ opacity: 0 }}
              ...
              <motion.h1
                ...
                className="text-lg sm:text-xl md:text-3xl font-bold text-green-800 dark:text-green-200"
              >
                {post.title}
              </motion.h1>
              {id && (
